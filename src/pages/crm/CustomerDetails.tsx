...
const CustomerDetails: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8" data-testid="customer-details-page">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white shadow-md rounded-lg p-6" data-testid="customer-details-card">
          ...
          <div className="space-y-2" data-testid="customer-details-info">
              ...
              <tbody>
                {activities.map((activity) => (
                  <tr
                    key={activity.id}
                    className="border-b"
                    data-testid="customer-details-activity-row"
                  >
      ...
      <div className="mt-8 text-center">
        <Link
          ...
          data-testid="customer-details-back"
        >
          Back to Customers
        </Link>
      </div>
