...
| P1       | Instrument UI with `data-testid` hooks for Cypress                  | In Progress | Core auth, planner shell, and operations planner dashboard now expose stable selectors for Cypress while the remaining flows are being instrumented; the Mr-DJ onboarding wizard and enterprise navigation now include deterministic test hooks for the dedicated onboarding specs.【F:src/ui/Login.tsx†L207-L293】【F:src/ui/FlowExperienceShell.tsx†L82-L146】【F:src/ui/Planner.tsx†L140-L210】【F:mr-dj-onboarding-enhanced/src/components/ImprovedOnboardingWizard.jsx†L138-L326】【F:mr-dj-onboarding-enhanced/src/components/MainNavigation.tsx†L95-L158】【F:mr-dj-onboarding-enhanced/src/App.jsx†L45-L95】 |
