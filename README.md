...
| P1       | Repair TypeScript compiler errors across UI, stores, and tests      | In Progress | Vendor typings and store updates reduced the failure set to 114 remaining issues, notably missing store APIs and planner metric types per the latest `npm run typecheck`.【F:src/vendor/zustand.ts†L1-L137】【F:types/vite/index.d.ts†L1-L74】【0abe8e†L1-L120】                                               |
