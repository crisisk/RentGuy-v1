...
| P1       | Resolve ESLint failures in UI and page modules                      | Complete    | `npm run lint` exits with no errors after pruning unused imports/state across the admin, crew, CRM, and planner views.【36563e†L1-L5】【F:src/pages/crew/CrewManagement.tsx†L1-L120】                                                                                                                                                                                                                                                                                                                                                                                                        |
| P1       | Instrument UI with `data-testid` hooks for Cypress                  | In Progress | Core auth, planner shell, and operations planner dashboard now expose stable selectors for Cypress, and the CRM list, form, detail, dashboard, and activity log views have matching hooks while the remaining flows are being instrumented.【F:src/ui/Login.tsx†L207-L293】【F:src/ui/FlowExperienceShell.tsx†L82-L146】【F:src/ui/Planner.tsx†L140-L210】【F:src/pages/crm/CustomerList.tsx†L44-L118】【F:src/pages/crm/CustomerForm.tsx†L82-L172】【F:src/pages/crm/CustomerDetails.tsx†L52-L148】【F:src/pages/crm/CRMDashboard.tsx†L44-L112】【F:src/pages/crm/ActivityLog.tsx†L41-L88】 |
